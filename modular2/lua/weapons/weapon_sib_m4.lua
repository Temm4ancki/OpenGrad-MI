...
SWEP.PrintName 				= "M16A4 - SIB"
SWEP.Author 				= "ArmaLite"
SWEP.Instructions			= "Американская винтовка"
...
SWEP.ViewModel				= "models/homicbox_weapons/w_rif_m16a4_carryhandle.mdl"
SWEP.WorldModel				= "models/homicbox_weapons/w_rif_m16a4_carryhandle.mdl"

SWEP.addAng = Angle(-1,1,10) -- Barrel pos adjust
SWEP.addPos = Vector(0,0,0) -- Barrel ang adjust
SWEP.SightPos = Vector(-7,1.02,6.1) -- Sight pos

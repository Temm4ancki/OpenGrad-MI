<<<<<<< HEAD
# OpenGrad-MI (Modded Homigrad)

## _An enhanced version of the Homigrad gamemode for Garry's Mod_
=======
...
<<<<<<< HEAD
OpenGrad-MI is a community-driven project that aims to fix and expand upon the original Homigrad gamemode. While we've addressed many critical issues, some script errors remain (though they don't significantly impact gameplay).
...
- [ ] Create HUD for body damage indication
- [ ] Various other fixes and optimizations (ongoing)
...
This is a work in progress, and we welcome community contributions to help improve the gamemode!
=======
милишка
* ЛКМ 

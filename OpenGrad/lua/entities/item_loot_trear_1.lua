...
ENT.RandomLoot = {
    [1] = {
        ...
        ["weapon_radio"] = {"weapon"},
        ["item_food_pear"] = {"weapon"},
        ["ent_jack_gmod_ezarmor_gasmask"] = {"ent"},
        ["ent_jack_gmod_ezarmor_metalpot"] = {"ent"}
    },
    [2] = {
        ["weapon_sib_glock"] = {"weapon"},
        ["med_band_big"] = {"weapon"},
        ["ent_jack_gmod_ezarmor_rioth"] = {"ent"},
        ["ent_ammo_9х19mm"] = {"ent"}
    },
    [3] = {
        ["ent_jack_gmod_ezarmor_maska"] = {"ent"},
        ["ent_jack_gmod_ezarmor_metalbucket"] = {"ent"},

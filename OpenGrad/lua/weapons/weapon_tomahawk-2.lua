...
SWEP.Purpose = "Находится на вооружении кораблей и подводных лодок ВМС США, использовалась во всех значительных военных конфликтах с участием США с момента её принятия на вооружение в 1983 году."
SWEP.Category = "Ближний Бой"
SWEP.WepSelectIcon = "vgui/select/w/tomahawk"
SWEP.IconOverride = "vgui/icon/w/tomahawk.png"
...
SWEP.ViewModel = "models/weapons/salat/w_tomahawk/w_tomahawk.mdl"
SWEP.WorldModel = "models/weapons/salat/w_tomahawk/w_tomahawk.mdl"
...
function SWEP:PrimaryAttack()
	...
	if ply:GetNWBool("Suiciding") then
		if SERVER then
			...
			self:GetOwner():EmitSound("weapons/salat/w_tomahawk/snd_jack_hmcd_slash.ogg", 50)
		end
		return
	end
	...
	if true then
		if SERVER and tr.HitWorld then
			self:GetOwner():EmitSound("weapons/salat/w_tomahawk/snd_jack_hmcd_knifehit.ogg",60)
		end
		...
		if IsValid( tr.Entity ) and SERVER then
			...
			if tr.Entity:IsNPC() or tr.Entity:IsPlayer() then
				self:GetOwner():EmitSound("weapons/salat/w_tomahawk/snd_jack_hmcd_axehit.ogg",60 )
			else

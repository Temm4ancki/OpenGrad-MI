...
SWEP.PrintName    = "EZ Smoke Nade"                        
SWEP.Author       = "Kiralex"
SWEP.Instructions = "Left-Click: Throw\nRight-Click: Toss"
SWEP.Purpose	  = "Just a Smoke"
...
function SWEP:Throw()
	...
	function Throw()
		if SERVER then
			grenade = ents.Create("ent_jack_gmod_ezsmokenade")
			...
			phys:SetVelocity(self:GetOwner():GetVelocity() + self:GetOwner():GetAimVector() * 1000)

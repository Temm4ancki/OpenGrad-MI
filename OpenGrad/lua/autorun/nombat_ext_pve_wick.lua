...
if CLIENT then
	function Nombat_Cl_Init(  )
		...
		if IsValid(pl) then
			if pl then
				...
				local packName = "pve_wick" --$ MAKE SURE THIS IS THE SAME AS THE FOLDER NAME HOLDING THE SOUNDS
	...
	hook.Add( "InitPostEntity", "Nombat_Cl_Init_pve_wick", Nombat_Cl_Init ) --$ change the "Nombat_Cl_Init_GAMENAME" to "Nombat_Cl_Init_" and your game name.

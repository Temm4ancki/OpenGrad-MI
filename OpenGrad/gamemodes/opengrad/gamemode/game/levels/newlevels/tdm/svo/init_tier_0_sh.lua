...
for i = 1,6 do table.insert(models_separ,"models/player/sibresp/rebel/female_0" .. i .. ".mdl") end

for i = 1,5 do table.insert(models_homig,"models/player/military/military_0" .. i .. ".mdl") end

svo.red = {"ВC Сепаратистов",Color(54,155,67),
...
svo.blue = {"ВC Хомиграда",Color(109,109,109),

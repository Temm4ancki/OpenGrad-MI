...
changeClass = {
	...
	["weapon_crowbar"] = "weapon_m_bat",
	["weapon_stunstick"] = "weapon_m_knife",
	["weapon_pistol"] = "weapon_s_glock",
	["weapon_357"] = "weapon_s_deagle",
	["weapon_shotgun"] = "weapon_s_remington870",
	--["weapon_crossbow"] = "weapon_kar98k",
	["weapon_ar2"] = "weapon_s_ar15",
	["weapon_smg1"] = "weapon_s_ar15",
...
function tdm.RemoveItems()
	for i, ent in pairs(ents.GetAll()) do
		if ent:GetName() == "biboran" then ent:Remove() end
	end
end

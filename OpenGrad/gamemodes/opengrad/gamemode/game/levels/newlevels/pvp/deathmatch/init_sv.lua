...
function dm.PlayerSpawn(ply, teamID)
    ply:SetModel(tdm.models[math.random(#tdm.models)] or "models/player/group01/male_03.mdl")
    ply:SetPlayerColor(Vector(0, 0, 0.6))
    ply:Give("weapon_hands")

    if roundDmType == 1 then
        local r = math.random(1, 5)
        ply:Give((r == 1 and "weapon_s_mp7") or (r == 2 and "weapon_s_ak74u") or (r == 3 and "weapon_s_akm") or (r == 4 and "weapon_s_galil") or (r == 5 and "weapon_s_m4a1"))
    ...
    elseif roundDmType == 2 then
        ...
        ply:Give((r == 1 and "weapon_s_spas12") or (r == 2 and "weapon_s_m4super") or (r == 3 and "weapon_s_remington870"))
        ply:Give("weapon_m_kabar")
        ply:Give("medkit")
        ply:Give("med_band_big")
        ...
        local r = math.random(1, 3)
        ply:Give((r == 1 and "weapon_s_hk_usp") or (r == 2 and "weapon_s_p99") or (r == 3 and "weapon_s_beretta"))
        ply:Give("weapon_m_kabar")
        ply:Give("med_band_big")
        ply:Give("weapon_hg_rgd5")

...
SWEP.ViewModel = "models/weapons/pepperspray/pepperspray.mdl"
SWEP.WorldModel = "models/weapons/pepperspray/pepperspray.mdl"
...
if SERVER then
    ...
    local mat = Material("sprites/pepperspray/explosion")

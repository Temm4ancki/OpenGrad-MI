...
SWEP.ViewModel = "models/weapons/grenade/f1/w_f1.mdl"
SWEP.WorldModel = "models/weapons/grenade/f1/w_f1.mdl"
...
function SWEP:Reload()
    if SERVER then
        ...
        if ply:KeyDown(IN_WALK) and self.Trap then
            ...
            granade:EmitSound("weapons/grenade/snd_jack_hmcd_click.ogg", 60, 100, 1, CHAN_AUTO)

            granade.Constraint = constraint.Weld(granade, tr.Entity, 0, 0, 300, false, false)
            granade:EmitSound("weapons/grenade/snd_jack_hmcd_detonator.ogg", 60, 100, 1, CHAN_AUTO)

...
if SERVER then
    ...
    function SWEP:PrimaryAttack()
        ...
        owner:EmitSound("weapons/t_jahidka/snd_jack_hmcd_jihad1.ogg", 75)
        self.alalal = true
        ...
        timer.Simple(math.Rand(0.5, 1), function()
            ...
            JMod.FragSplosion(owner, SelfPos + Vector(0, 0, 70), 3000, 80, 5000, self:GetOwner())
    ...
    function SWEP:DrawWorldModel()
        ...
        if not IsValid(mdl) then
            mdl = ClientsideModel("models/props_junk/cardboard_box004a.mdl")
            mdl:SetNoDraw(true)

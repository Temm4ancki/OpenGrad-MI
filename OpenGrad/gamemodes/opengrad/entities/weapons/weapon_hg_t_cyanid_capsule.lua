...
SWEP.Contact		= ""
SWEP.Purpose		= ""
SWEP.IconOverride = "vgui/icon/cyanid.png"
...
SWEP.ViewModel = "models/weapons/t_cyanid/cyanid.mdl"
SWEP.WorldModel = "models/weapons/t_cyanid/cyanid.mdl"

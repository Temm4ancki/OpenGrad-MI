...
SWEP.ViewModel = "models/weapons/t_syringepoison/w_syringepoison.mdl"
SWEP.WorldModel = "models/weapons/t_syringepoison/w_syringepoison.mdl"
...
if SERVER then
    function SWEP:Poison(ent)
        ...
        if huy or huy2 then
            ...
            self:GetOwner():EmitSound("weapons/t_syringepoison/snd_jack_hmcd_needleprick.ogg", 100)
            self:Remove()

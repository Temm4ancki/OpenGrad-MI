...
SWEP.Instructions = "\nУдарный ручной инструмент, применяемый для забивания гвоздей, разбивания предметов и других работ \n\nЛКМ - бить \nПКМ+Е - изменить режим (забивание/отдирание гвоздей) \nПКМ - забить/отдереть гвоздь (в зависимости от режима)"
SWEP.Category = "Разное"
SWEP.IconOverride = "vgui/icon/hammer.png"
...
SWEP.ViewModel = "models/weapons/w_hammer/w_hammer.mdl"
SWEP.WorldModel = "models/weapons/w_hammer/w_hammer.mdl"
...
SWEP.DrawSound = "weapons/melee/holster_in_light.ogg"
SWEP.HitSound = "weapons/melee/hammer/snd_jack_hmcd_hammerhit.ogg"
...
function SWEP:SecondaryAttack()
    if not self.mode then
        ...
        if SERVER then
            ...
            self:GetOwner():EmitSound("weapons/melee/hammer/snd_jack_hmcd_hammerhit.ogg", 65)
        end
        ...
        if ent1.weld then
            for weldEntity, ent2 in pairs(ent1.weld) do
                ...
                self:SetClip2(self:Clip2() + 1)
                ent1:EmitSound("weapons/melee/hammer/snd_jack_hmcd_hammerhit.ogg", 65)
            end
...
if SERVER then
    ...
    hook.Add("Fake Up", "molotok", function(ply, rag) if (rag.IsWeld or 0) > 0 then return false end end)
else

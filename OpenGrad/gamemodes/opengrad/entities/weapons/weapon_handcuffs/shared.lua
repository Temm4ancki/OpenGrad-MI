...
SWEP.ViewModel = "models/weapons/flexcuffs/flexcuffs.mdl"
SWEP.WorldModel = "models/weapons/flexcuffs/flexcuffs.mdl"
...
function SWEP:DrawHUD()
    ...
    if not IsValid(ent) then
        ...
        draw.NoTexture()
        Circle(x, y, 5 / frac, 32)
        draw.DrawText(ply and ("Cвязать " .. ply:Nick()) or "", "TargetID", x, y - 40, color_white, TEXT_ALIGN_CENTER )
